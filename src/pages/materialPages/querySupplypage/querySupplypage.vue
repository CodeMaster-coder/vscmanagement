        ...
        <div class="querySupplypage_linebox">
          <div class="querySupplypage_input-group">
            <div class="querySupplypage_label">
              <div class="querySupplypage_label1">耗材名称</div>
              <div class="querySupplypage_label2">(Name)</div>
            </div>
            <div>
      ...
      <div class="querySupplypage_bigtempbox">
        <div class="querySupplypage_tempbox">
          <div class="querySupplypage_columnbox1">
            <div class="querySupplypage_title">耗材名称</div>
          </div>
        ...
        <div class="querySupplypage_tempbox">
          <div class="querySupplypage_columnbox1">
            <div class="querySupplypage_title">(Name)</div>
          </div>
          <div class="querySupplypage_columnbox2">
  ...
  export default {
    ...
    methods: {
      ...
      exportbtn(){
        ...
        // 导出Excel文件
        XLSX.writeFile(workbook, "materialSupplyHistory.xlsx");
        }
    },
    mounted() {
      // 发起查询操作等
