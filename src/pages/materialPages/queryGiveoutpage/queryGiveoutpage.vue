<template>
        ...
        <div class="queryGiveoutpage_linebox">
          <div class="queryGiveoutpage_input-group">
            <div class="queryGiveoutpage_label">
              <div class="queryGiveoutpage_label1">耗材名称</div>
              <div class="queryGiveoutpage_label2">(Name)</div>
            </div>
            <div>
        ...
        <div class="queryGiveoutpage_bigtempbox">
          <div class="queryGiveoutpage_tempbox">
            <div class="queryGiveoutpage_columnbox1">
              <div class="queryGiveoutpage_title">耗材名称</div>
            </div>
            <div class="queryGiveoutpage_columnbox2">
              <div class="queryGiveoutpage_title">耗材型号</div>
            </div>
  ...
  export default {
    ...
    exportbtn(){
      ...
      // 导出Excel文件
      XLSX.writeFile(workbook, "materialGiveoutHistory.xlsx");
      }
    },
    mounted() {
