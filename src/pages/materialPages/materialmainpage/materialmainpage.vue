...
export default {
  ...
  methods: {
    naviToStorage() {
      // 处理点击库存图标的逻辑
      this.$router.push('/material/storagepage')
    },
    naviToGiveout() {
      // 处理点击审批图标的逻辑
      this.$router.push('/material/approvePage')
    },
    naviToSupply() {
      // 处理点击补库图标的逻辑
      this.$router.push('/material/supplyPage')
    },
    naviToMidpage() {
      // 处理点击查询图标的逻辑
      this.$router.push('/material/queryMidPage')
    },
