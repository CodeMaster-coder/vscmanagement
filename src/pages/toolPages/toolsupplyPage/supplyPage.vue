  ...
  export default {
    ...
    methods: {
      ...
      if (this.chosenName === '') {
        ...
        this.giveoutNum = '';
        this.giveoutPcs = '';
        this.$message.success('添加成功！(Successfully added!)');
      }
    },
        ...
        this.$axios.post(
              ...
              response => {
                  ...
                  if(response.data.status){
                    ...
                    this.$message.success('补库数据提交成功！(Submit supply data successfully!)')
                  }else{
                    this.$message.error('补库数据提交失败，请重试！(Submit supply data failed, please try again!)')
                  }
